...
class MainFrame(wx.Frame):
	...
	def __create_tree_pane_sizer(self, parent):
		...
		mainOptionsGridSizer.Add(self.sliderValueLabel, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
	...
	def __doLayout(self):
		...
		configTabFilenameRECleanerGridSizer.Add(self.regexValidLabel, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
		...
		configTabFilenameCleanerGridSizer.Add(self.stripListValidLabel, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
		...
		specialOptionsGridSizer.Add(self.valueWordLengthWeighting, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
		...
		specialOptionsGridSizer.Add(self.valueStrLengthDifferenceWeighting, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
		...
		specialOptionsGridSizer.Add(self.valueWordLengthDifferenceWeighting, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
